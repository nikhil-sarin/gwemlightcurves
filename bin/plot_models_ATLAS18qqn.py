...
def parse_commandline():
    ...
    parser.add_option("-e","--event",default="ATLAS18qqn")
    parser.add_option("--distance",default=60.0,type=float)
    parser.add_option("--T0",default=58285.441,type=float)
